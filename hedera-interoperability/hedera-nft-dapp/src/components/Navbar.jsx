    ...
    >
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <Link
            to="/"
            className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-blue-400 bg-clip-text text-transparent flex items-center"
          >
            <img
              src="/logo.png"
              alt="NFT Manager Logo"
              className="h-10 w-auto mr-2"
            />
            <span className="hidden sm:inline-block">NFT Manager</span>
          </Link>
          ...
          <div className="flex items-center space-x-4">
            {account ? (
              <motion.div
                ...
                animate={{ opacity: 1 }}
              >
                <span title={account} className="font-medium text-indigo-700">
